...
%
\title{What's Cooking……!!2222333} %总标题
\author{
Yuhui Mou
\\
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Overview}  %第二页slides，标题以及目录
\tableofcontents
\end{slide}
%%
%%==========================================================================================
...
\twotonebox {\rotatebox{90}{Cooooook}}{\parbox{.88\textwidth}
{
% {\textcolor{orange}{What's Cooking?} aims to identify
...
% % \end{itemize}
% }
\emph{Summary}:\textcolor{orange}{Use recipe ingredients to categorize the cuisine} \\
There are many countries on the earth, each country has its own characteristic food culture. \\
Picture yourself strolling through your local, open-air market... 
What do you see? What do you smell? What will you make for dinner tonight?
...
India’s market is perhaps the most colorful, awash in the rich hues and aromas of dozens of spices: turmeric, 
star anise, poppy seeds, and garam masala as far as the eye can see.
}}
...
%%==========================================================================================
%%
\begin{slide}[toc=,bm=]{Data}
  \twotonebox {\rotatebox{90}{Data}}{\parbox{.88\textwidth}
  {
  % {\textcolor{orange}{What's Cooking?} aims to identify
  % the \textcolor{orange}{top-k group outlying subspace $s \subseteq F$} in
  % which the query group $G_q$ is \textcolor{orange} {distinctive with other groups}.
  ...
  % \end{itemize}
  % }
  In the dataset, we include the recipe id, the type of cuisine, 
  and the list of ingredients of each recipe (of variable length). 
  ...
  \end{itemize}
  In the test file test.json, the format of a recipe is the same as train.json, only the cuisine type is removed, 
  as it is the target variable you are going to predict.
  }}
  \end{slide}
%%==========================================================================================
%%
